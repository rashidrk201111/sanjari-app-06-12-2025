...
gcloud run deploy %GCP_SERVICE_NAME% ^
    ...
    --min-instances 0 ^
    --max-instances 10 ^
    --set-env-vars "VITE_SUPABASE_URL=%VITE_SUPABASE_URL%,VITE_SUPABASE_ANON_KEY=%VITE_SUPABASE_ANON_KEY%,VITE_RAZORPAY_KEY_ID=%VITE_RAZORPAY_KEY_ID%,VITE_PHONEPE_MERCHANT_ID=%VITE_PHONEPE_MERCHANT_ID%,VITE_APP_URL=%VITE_APP_URL%"
